package com.adrpien.tiemed.feature_inspections.presentation
...
import com.adrpien.tiemed.feature_inspections.domain.InspectionListAdapter
import com.adrpien.tiemed.feature_inspections.domain.InspectionListViewModel
import com.adrpien.tiemed.feature_inspections.domain.OnInspectionClickListener
    ...
    override fun setOnInspectionItemClickListener(itemView: View, position: Int) {
        ...
        if(inspectionUid != null) {
            findNavController().navigate(
                com.adrpien.tiemed.inspectionlist.InspectionListFragmentDirections.actionInspectionListFragmentToEditInspectionFragment().actionId,
